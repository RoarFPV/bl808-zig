# 1 "../bouffalo_drivers/lhal/src/bflb_acomp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
#define __llvm__ 1
#define __clang__ 1
...
#define CPU_M0 1
# 1 "<built-in>" 2
# 1 "../bouffalo_drivers/lhal/src/bflb_acomp.c" 2
...
void bflb_acomp_init(uint8_t acomp_id, const struct bflb_acomp_config_s *config)
{
    ...
    if (AON_ACOMP0_ID == acomp_id) {
        reg_base = ((uint32_t)0x2000f000) + AON_ACOMP_REG_ACOMP0_CTRL_OFFSET;
    } else {
        reg_base = ((uint32_t)0x2000f000) + AON_ACOMP_REG_ACOMP1_CTRL_OFFSET;
    }
    ...
    reg_base = ((uint32_t)0x2000f000) + AON_ACOMP_REG_ACOMP_CFG_OFFSET;
    regval = getreg32(reg_base);
...
{
# 186 "../bouffalo_drivers/lhal/src/bflb_acomp.c"
    if (pin == GPIO_PIN_17) {
...
{
# 294 "../bouffalo_drivers/lhal/src/bflb_acomp.c"
