...
pub const memorymap = struct {
    ...
    pub const UART = &[_]types.peripherals.UART{
        UART0,
        UART1,
        UART2,
        UART3,
    };
    pub const SPI = &[_]types.peripherals.SPI{
        SPI0,
        SPI1,
    };
    pub const I2C = &[_]types.peripherals.I2C{
        I2C0,
        I2C1,
        I2C2,
        I2C3,
    };
    pub const TIMER = &[_]types.peripherals.TIMER{
        TIMER0,
        TIMER1,
    };
    pub const IPC = &[_]types.peripherals.NotFound{
        IPC0,
        IPC1,
        IPC2,
    };
    pub const PDM = &[_]types.peripherals.NotFound{
        PDM0,
    };
    pub const DMA = &[_]types.peripherals.DMA{
        DMA0,
        DMA1,
        DMA2,
    };
    pub const DVP = &[_]types.peripherals.NotFound{
        DVP0,
        DVP1,
        DVP2,
        DVP3,
    ...
    pub const DVP_TSRC = &[_]types.peripherals.NotFound{
        DVP_TSRC0,
        DVP_TSRC1,
    };
};
