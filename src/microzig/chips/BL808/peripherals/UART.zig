...
pub const Type = extern struct {
    ...
    // 0x20
    @"UART interrupt status": mmio.Mmio(packed struct(u32) {
        utx_end_int: u1,
        urx_end_int: u1,
        utx_fifo_int: u1,
        urx_fifo_int: u1,
    ...
    // 0x24
    @"UART interrupt mask": mmio.Mmio(packed struct(u32) {
        cr_utx_end_mask: u1,
        cr_urx_end_mask: u1,
        cr_utx_fifo_mask: u1,
        cr_urx_fifo_mask: u1,
    ...
    // 0x28
    @"UART interrupt clear": mmio.Mmio(packed struct(u32) {
        cr_utx_end_clr: u1,
        cr_urx_end_clr: u1,
        reserved2: u2,
        cr_urx_rto_clr: u1,
    ...
    // 0x2c
    @"UART interrupt enable": mmio.Mmio(packed struct(u32) {
        cr_utx_end_en: u1,
        cr_urx_end_en: u1,
        cr_utx_fifo_en: u1,
        cr_urx_fifo_en: u1,
