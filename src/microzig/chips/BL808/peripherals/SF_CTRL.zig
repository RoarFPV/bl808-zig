...
pub const Type = extern struct {
    ...
    // 0x0
    if_io_dly_0: mmio.Mmio(packed struct(u32) {
        cs_dly_sel: u2,
        cs2_dly_sel: u2,
        reserved4: u4,
        clk_out_dly_sel: u2,
    ...
    // 0x4
    if_io_dly_1: mmio.Mmio(packed struct(u32) {
        io_0_oe_dly_sel: u2,
        reserved2: u6,
        io_0_di_dly_sel: u2,
        reserved10: u6,
    ...
    // 0x8
    if_io_dly_2: mmio.Mmio(packed struct(u32) {
        io_1_oe_dly_sel: u2,
        reserved2: u6,
        io_1_di_dly_sel: u2,
        reserved10: u6,
    ...
    // 0xc
    if_io_dly_3: mmio.Mmio(packed struct(u32) {
        io_2_oe_dly_sel: u2,
        reserved2: u6,
        io_2_di_dly_sel: u2,
        reserved10: u6,
    ...
    // 0x10
    if_io_dly_4: mmio.Mmio(packed struct(u32) {
        io_3_oe_dly_sel: u2,
        reserved2: u6,
        io_3_di_dly_sel: u2,
        reserved10: u6,
